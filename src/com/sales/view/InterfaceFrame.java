...
public class InterfaceFrame extends javax.swing.JFrame {
    ...
    private ArrayList<SalesInvoiceHF> invoices;
    private Controller controller = new Controller(this);
    private SalesInvoicesHFTableModel invoicesTableModel;

    public ArrayList<SalesInvoiceHF> getInvoices() {
        return invoices;
    }
    ...
    public SalesInvoicesHFTableModel getInvoicesTableModel() {
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(SalesInvoicesHFTableModel invoicesTableModel) {
        this.invoicesTableModel = invoicesTableModel;
    }

    public void setInvoices(ArrayList<SalesInvoiceHF> invoices) {
